...
function AddParentRecommendation() {
  return (
    <section className="flex">
      ...
      <div className="flex flex-col overflow-hidden w-full p-4">
        <div className="bg-white rounded-md py-10 mx-10 my-5">
            <h2 className="text-xl font-medium text-gray-700 mx-5 my-5">Add Parent Recommendation</h2>
          <div className="grid grid-cols-1 gap-6 mx-5">

            <div className="flex flex-col">
              <textarea
                name=""
                placeholder="Parent Recommendation Point"
...
export default AddParentRecommendation