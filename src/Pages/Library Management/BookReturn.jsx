  ...
  const columns = [
    {
      name: "View",
      cell: (row) => (
        <Link to={`/school-management/library/request-book-details/${row.id}`}>
          <BsEye size={15} />
        </Link>
      ),
    },
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="flex items-center gap-4">
          <Link to={`/school-management/library/edit-book-return/${row.id}`}>
            <BiSolidEdit size={15} />
          </Link>
          <button>
      ...
      <div className="flex">
        ...
        <div className="flex flex-col overflow-hidden w-full">
          <div className="flex justify-between mx-5 my-5">
            <p className="text-xl font-bold text-gray-600"> Book Return</p>
            <Link
              to={`/school-management/library/add-book-return`}
