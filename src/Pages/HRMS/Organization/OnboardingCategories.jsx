...
import EditOnboardingCategoriesModal from "./EditOnboardingCategoriesModal";
function OnboardingCategories() {
  const [editModal, setEditModal] = useState(false);
  const columns = [
    {
      name: "Task Category Label",
      selector: (row) => row.task_category_label,
      sortable: true,
    },
    {
      name: "Last Updated",
  ...
  return (
    <div>
      ...
      <div className="flex ml-24">
        ...
        {editModal && (
          <EditOnboardingCategoriesModal onClose={() => setEditModal(false)} />
        )}
      </div>
    </div>
  );
