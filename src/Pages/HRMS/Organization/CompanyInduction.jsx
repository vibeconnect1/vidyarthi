  ...
  return (
    <div>
      ...
      <div className="flex ml-24">
        ...
        {editModal && (
          <EditCompanyInductionModal onClose={() => setEditModal(false)} />
        )}
      </div>
    </div>
  );
