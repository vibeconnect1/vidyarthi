              ...
              <div className="flex flex-col mt-4 mr-2 bg-white rounded-md text-wrap  gap-4 my-2 py-2 pl-5 pr-2 w-[18rem]">
                ...
                <div className=" ">
                  ...
                  <ul className="list-disc pl-5 flex flex-col gap-2">
                    ...
                    <li>
                      You can add and manage third party users and invite them
                      to join login to the Quikchex software. For e.g., External
