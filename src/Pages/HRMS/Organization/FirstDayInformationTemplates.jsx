...
function FirstDayInformationTemplates() {
    ...
    const columns = [
      ...
      const data = [
        {
          id: 1,
          template_name: "First Day Information Template",
          updated_by: "Rk Yadav",
  ...
  return (
    <div>
      ...
      <div className="flex ml-24">
        ...
        {editModal && <EditFirstDayInformationTemplatesModal onClose={() => setEditModal(false)} />}
      </div>
    </div>
  );
}

export default FirstDayInformationTemplates;
