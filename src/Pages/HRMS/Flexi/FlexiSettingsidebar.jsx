...
const FlexiSettingsidebar = () => {
  const [open, setOpen] = useState(true);
  return (
    <div className="flex">
      <AdminHRMS />
      <div className="w-72 h-auto bg-white rounded-md border-r p-4">
        <ul className="space-y-4">
          ...
          <li>
            <NavLink
              to="/hrms/flexi/setting/flexi-benefit-categories"
              className={({ isActive }) =>
                `${
                  isActive
                    ? "text-white bg-blue-500 flex p-2 gap-3.5 rounded-md group items-center text-sm font-medium"
          ...
          <li>
            <NavLink
              to="/hrms/flexi/flexi-benefit-supervisor-assignment"
              className={({ isActive }) =>
                `${
                  isActive
                    ? "text-white bg-blue-500 flex p-2 gap-3.5 rounded-md group items-center text-sm font-medium"
...
export default FlexiSettingsidebar