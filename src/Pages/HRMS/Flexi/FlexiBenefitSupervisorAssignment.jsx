...
function FlexiBenefitSupervisorAssignment() {
  const columns = [
    {
      name: "Employee Name",
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="flex items-center">
          <Link
            to={`/hrms/flexi/setting/edit-flexi-benefit-categories/${row.id}`}
  ...
  const data = [
    {
      id: 1,
      employee_name: "Vinayak Kapdoskar",
      supervisors:"Level 1: Vinayak Ka..."
    },
  ];
  return (
        ...
        <div className="col-span-6 my-3 rounded-md">
          <div className="flex justify-between">
            <h2 className="flex items-center text-gray-800 text-xl font-medium">
              Flexi Benefit Supervisor Assignment
            </h2>
...
export default FlexiBenefitSupervisorAssignment;
