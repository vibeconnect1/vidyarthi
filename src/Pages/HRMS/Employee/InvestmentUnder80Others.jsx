              ...
              <div className="bg-white rounded-md px-5 py-10 space-y-5 ">
                <div className="border border-gray-500 rounded-md px-5 py-2">
                  <div className="flex gap-3 ">
                    <img src={familyInsurance} className="h-12 w-12 "></img>
                    <h2 className="text-xl font-medium text-gray-600 flex items-center">
                      Medical Insurance Premium - For Self, Spouse and Children
                    </h2>
                  </div>
...
export default InvestmentUnder80Others;
