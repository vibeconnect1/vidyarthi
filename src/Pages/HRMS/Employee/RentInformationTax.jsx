...
function RentInformationTax() {
  ...
  const columns = [
    ...
    {
      name: "Rent Declared (In ₹)",
      selector: (row) => row.rent_declared,
      sortable: true,
    },
    {
...
export default RentInformationTax;
