...
function AttendanceTemplate() {
  const columns = [
    ...
    },
    {
      ...
      selector: (row) => row.no_of_active_employees_covered,
      sortable: true,
    },
    {
      name: "Employee TimeClock",
      selector: (row) => row.employee_timeClock,
      sortable: true,
    },
    {
      name: "Late/Early Mark",
      selector: (row) => row.late_early_mark,
      sortable: true,
    },
    {
      name: "Action",
  ...
  const data = [
    {
      ...
      no_of_active_employees_covered: "23",
      employee_timeClock: (
        <div className="bg-green-500 p-1 flex justify-center items-center rounded-md text-white h-4 w-4">
          <FaCheck />
        </div>
      ),
      late_early_mark: (
        <div className="bg-red-500 p-1 flex justify-center items-center rounded-md text-white h-4 w-4">
          <IoMdClose />
        </div>
      ),
    },
    {
      id: 2,
      template_name: "Finance Employees	",
      no_of_active_employees_covered: "1",
      employee_timeClock: (
        <div className="bg-red-500 p-1 flex justify-center items-center rounded-md text-white h-4 w-4">
          <IoMdClose />
        </div>
