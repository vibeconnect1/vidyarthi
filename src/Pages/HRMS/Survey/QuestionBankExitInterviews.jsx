...
function QuestionBankExitInterviews() {
  ...
  const questionBankData = [
    {
      id: 1,
      questions:
        "Q.1: Please choose the Industry of your newly joined company (if Any). Specify the name of the company in comments",
      template: "0",
      status: "Active",
...
export default QuestionBankExitInterviews;
