...
function QuestionBankGeneralSurvey() {
  ...
  const questionBankData = [
    {
      id: 1,
      questions:
        "Q.1: On a scale of 1-10, how well does the organization accommodate employees' requests for time off to attend personal events or fulfill family responsibilities?",
      template: "0",
      status: "Active",
      category: "Impact of Work on Personal Life",
    },
  ];
  ...
  const myQuestionsData = [
    {
      id: 1,
      questions: "Q.1: Are you comfortable in working with your team?",
      created_on: "01-04-2024",
      template: "1",
      status: "Active",
      category: "Team Collaboration and Communication",
    },
  ];
  return (
...
export default QuestionBankGeneralSurvey;
