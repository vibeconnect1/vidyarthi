...
const TimesheetManagementSetting = () => {
    ...
    <div className="flex">
      ...
      <div className="w-72 h-auto bg-white rounded-md border-r p-4 mt-9">
        <ul className="space-y-4">
          ...
          <li>
            ...
            {dropdownOpen && (
              <ul className="pl-8 space-y-2 mt-2">
                ...
                <li>
                  <NavLink
                    to="/hrms/time-sheet/time-sheet-clients"
                    className={({ isActive }) =>
                      `${
                        isActive
                          ? "text-white bg-blue-500 flex p-2 gap-3.5 rounded-md group items-center text-sm font-medium"
                ...
                <li>
                  <NavLink
                    to="/hrms/time-sheet/time-sheet-project"
                    className={({ isActive }) =>
                      `${
                        isActive
                          ? "text-white bg-blue-500 flex p-2 gap-3.5 rounded-md group items-center text-sm font-medium"
                ...
                <li>
                  <NavLink
                    to="/hrms/time-sheet/time-sheet-task"
                    className={({ isActive }) =>
                      `${
                        isActive
                          ? "text-white bg-blue-500 flex p-2 gap-3.5 rounded-md group items-center text-sm font-medium"
                ...
                <li>
                  <NavLink
                    to="/hrms/time-sheet/time-sheet-custom-fields"
                    className={({ isActive }) =>
                      `${
                        isActive
                          ? "text-white bg-blue-500 flex p-2 gap-3.5 rounded-md group items-center text-sm font-medium"
          ...
          <li>
            <NavLink
              to="/hrms/time-sheet/time-sheet-templates"
              className={({ isActive }) =>
                `${
                  isActive
                    ? "text-white bg-blue-500 flex p-2 gap-3.5 rounded-md group items-center text-sm font-medium"
          ...
          <li>
            <NavLink
              to="/hrms/time-sheet/time-sheet-assignment"
              className={({ isActive }) =>
                `${
                  isActive
                    ? "text-white bg-blue-500 flex p-2 gap-3.5 rounded-md group items-center text-sm font-medium"
...
export default TimesheetManagementSetting;
