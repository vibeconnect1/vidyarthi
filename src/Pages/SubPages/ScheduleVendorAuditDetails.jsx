...
import AddVendorItemModal from "../Modal/AddVendorItemModal";

const ScheduleVendorAuditDetails = () => {
  ...
  return (
    <div>
      ...
      <div className="flex">
        ...
        <div className="flex flex-col w-full overflow-hidden">
          <div className="flex gap-2 justify-end mt-5 mx-5">
            ...
            <Link
              to={`/school-management/edit-schedule-vendor-audit/${id}`}
      ...
      {
        itemModal && (<div>
            <AddVendorItemModal onclose={() =>setItemModal(false)} />
        </div>)
      }
    </div>
  );
...
export default ScheduleVendorAuditDetails