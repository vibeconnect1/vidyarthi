...
const AddScheduleVendorAudit = () => {
  ...
  const renderTaskFields = () => (
    <div className="grid md:grid-cols-3 gap-5">
      <div className="grid gap-5 space-y-5 my-5 items-center w-full">
  ...
  const renderScheduleFields = () => (
    <div>
      ...
      <div className="grid md:grid-cols-3 gap-5 space-y-3 my-5">
        <div>
          <label htmlFor="assignTo" className="font-semibold my-2">
            Checklist Type:
          </label>
          <form>
            <label>
    ...
    <section>
      ...
      <div className="flex">
        ...
        <div className="flex flex-col w-full overflow-hidden">
          <h2 className="text-center text-xl font-bold p-2 rounded-md mx-10 my-3 bg-white">
            Schedule Audit
          </h2>
...
export default AddScheduleVendorAudit