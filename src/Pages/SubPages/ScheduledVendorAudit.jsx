...
const ScheduledVendorAudit = () => {
  const columns = [
    {
      ...
      cell: (row) => (
        <div className="flex items-center gap-4">
          <Link to={`/school-management/schedule-vendor-audit-details/${row.id}`}>
            <BsEye size={15} />
          </Link>
          <Link to={`/school-management/edit-schedule-vendor-audit/${row.id}`}>
            <BiEdit size={15} />
          </Link>
        </div>
      ),
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex md:flex-row md:justify-between flex-col gap-10 my-2 mx-5">
        ...
        <div className="flex gap-2">
          <Link
            to={"/school-management/add-schedule-vendor-audit"}
